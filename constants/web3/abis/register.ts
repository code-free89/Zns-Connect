export const REGISTRY_ABI = [
  {
    inputs: [
      ...
      { internalType: "address", name: "_giftCard", type: "address" },
  ...
  { inputs: [], name: "InvalidDomainName", type: "error" },
  ...
  {
    inputs: [
      { internalType: "address", name: "_giftCardAddress", type: "address" },
    ],
    name: "setGiftCard",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "uint256[5]", name: "_ticks", type: "uint256[5]" },
    ],
    name: "setReferTicks",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "address", name: "_newMaintainer", type: "address" },
    ],
